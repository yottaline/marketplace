CREATE TABLE IF NOT EXISTS
  `users` (
    ...
    `user_account` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS
  `admins` (
    ...
    `admin_account` INT UNSIGNED NOT NULL,
    `admin_status` BOOLEAN NOT NULL DEFAULT '1',
    PRIMARY KEY (`admin_id`),
    FOREIGN KEY (`admin_account`) REFERENCES `users` (`user_type`)
  ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS
   `locations` (
    ...
    `location_code` VARCHAR(9) NOT NULL,
...
CREATE TABLE IF NOT EXISTS
  `retailers` (
    ...
    `retailer_account` INT UNSIGNED NOT NULL,
    ...
    `retailer_location` INT UNSIGNED NOT NULL,
    ...
    FOREIGN KEY (`retailer_location`) REFERENCES `locations` (`location_id`),
    FOREIGN KEY (`retailer_account`) REFERENCES `users` (`user_type`)
  ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS
  `customers` (
    ...
    `customer_account` INT UNSIGNED NOT NULL,
    `retailer_phone` VARCHAR(24) NOT NULL,
    ...
    FOREIGN KEY (`customer_location`) REFERENCES `locations` (`location_id`),
    FOREIGN KEY (`customer_account`) REFERENCES `users` (`user_type`)
  ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS
  `subcategories` (
    ...
    `subcategory_cate` INT UNSIGNED NOT NULL,
    `subcategory_status` BOOLEAN NOT NULL DEFAULT '1',
    PRIMARY KEY (`subcategory_id`),
    FOREIGN KEY (`subcategory_cate`) REFERENCES `categories` (`category_id`)
  ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS
  `products_sizes` (
    ...
    `prodsize_name` VARCHAR(120) DEFAULT NULL,
    `prodsize_sign` VARCHAR(12) DEFAULT  NULL,
    `prodsize_code` VARCHAR(8) NOT NULL,
    `prodsize_media` VARCHAR(64) NULL,
