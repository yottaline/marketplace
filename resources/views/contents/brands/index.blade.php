                            ...
                            <table class="table table-hover" id="example">
                                ...
                                <tbody>
                                    <tr ng-repeat="brand in list track by $index">
                                        ...
                                        <td ng-bind="brand.brand_name" class="small font-monospace text-uppercase">
                                        </td>
                                        <td class="text-center">
                                            <span ng-click="editStatus(brand)" style="cursor:pointer"
...
@section('js')
    <script>
        ...
        app.controller('ngCtrl', function($scope) {
            ...
            $scope.editStatus = (brand) => {
                var request = {
                    admin: brand.admin_id,
                    status: brand.admin_status,
                    _token: '{{ csrf_token() }}'
                };
