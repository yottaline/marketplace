                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="name" name="name" class="form-control" maxlength="120"
                                            ng-value="list[updatesize].size_name" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="sign" name="sign" class="form-control"
                                            ng-value="list[updatesize].size_sign">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" role="switch" name="status"
                                            value="1" ng-checked="+list[updatesize].size_status" id="sizeStatus">
